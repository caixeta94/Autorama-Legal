...
Documentos legais de **Autorama** (`com.uaigames.autorama`) — publicados via GitHub Pages.
...
2. A URL fica `https://caixeta94.github.io/Autorama-Legal/`

## URLs para a ficha da Play Store

| Campo do Play Console | URL |
|---|---|
| Política de Privacidade | `https://caixeta94.github.io/Autorama-Legal/privacidade.html` |
| Exclusão de conta (Data safety) | `https://caixeta94.github.io/Autorama-Legal/exclusao-de-conta.html` |
| Site do desenvolvedor | `https://caixeta94.github.io/Autorama-Legal/` |
...
- [ ] Os flags de feature em `games.json` batem com o que o app **realmente faz**
      (hoje: `leaderboard, replay, ghost, crash_reports, analytics`). Data Safety divergente do comportamento real é a causa
